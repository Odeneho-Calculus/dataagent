...
This guide provides a structured approach to migrate **Highest Data Hub** from a Firebase + Vanilla JS frontend to a modern, scalable React + Node.js stack with MongoDB Atlas as the database.
...
# Database
MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/highest_data_hub?retryWrites=true&w=majority
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <div>
              <div className="font-bold text-slate-900 dark:text-white">HIGHEST</div>
...
NODE_ENV=production
PORT=5000
MONGODB_URI=mongodb+srv://prod_user:prod_pass@cluster.mongodb.net/highest_data_hub
