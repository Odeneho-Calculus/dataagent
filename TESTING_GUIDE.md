...
```env
MONGODB_URI=mongodb+srv://your_username:your_password@cluster.mongodb.net/highest_data_hub?retryWrites=true&w=majority
```
...
3. Looking at the `highest_data_hub` database
