        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="rounded-lg shadow-xl max-w-lg w-full p-8 card">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xl font-bold mb-2" style={{color: 'var(--text-primary)'}}>Opening Payment Gateway</h3>
              <p className="text-sm" style={{color: 'var(--text-secondary)'}}>Please wait while we initialize Paystack...</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="rounded-lg shadow-xl max-w-lg w-full p-8 card">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm" style={{color: 'var(--text-secondary)'}}>Please wait while we verify your payment...</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="rounded-lg shadow-xl max-w-lg w-full p-8 card">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mb-4" style={{color: 'var(--text-secondary)'}}>Your data bundle has been purchased for GHS {amount.toFixed(2)}</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="rounded-lg shadow-xl max-w-lg w-full p-8 card">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mb-4" style={{color: 'var(--text-secondary)'}}>You cancelled the payment. Your order was not processed.</p>
              <button
                onClick={onClose}
